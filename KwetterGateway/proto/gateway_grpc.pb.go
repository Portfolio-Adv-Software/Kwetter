...
const (
	TrendService_GetTrend_FullMethodName = "/TrendService/GetTrend"
)
...
const (
	TweetService_ReturnAll_FullMethodName   = "/TweetService/ReturnAll"
	TweetService_ReturnTweet_FullMethodName = "/TweetService/ReturnTweet"
	TweetService_PostTweet_FullMethodName   = "/TweetService/PostTweet"
)

...
const (
	...
	TrendService_DeleteData_FullMethodName = "/proto.TrendService/DeleteData"
)
...
func (c *trendServiceClient) DeleteData(ctx context.Context, in *DeleteDataReq, opts ...grpc.CallOption) (*DeleteDataRes, error) {
	out := new(DeleteDataRes)
	err := c.cc.Invoke(ctx, TrendService_DeleteData_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTrendServiceServer) DeleteData(context.Context, *DeleteDataReq) (*DeleteDataRes, error) {
...
func _TrendService_DeleteData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteDataReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TrendServiceServer).DeleteData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TrendService_DeleteData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrendServiceServer).DeleteData(ctx, req.(*DeleteDataReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TrendService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TrendService_DeleteData_Handler,
		},
	},
